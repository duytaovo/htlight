...
const Comment = ({ replies, productData }: any) => {
  ...
  const handleClickSex = (id: number) => {
    setChecksex(id);
  };
  ...
  const getReplies = (id: any) => {
    // return commentByProduct.data
  ...
  return (
    <div className={styles.wrap}>
      ...
      <div className={styles.body}>
        {/* {commentByProduct.data.map((item, index) => {
